// Root OS component — manages the high-level screen state machine:
//   booting → desktop (normal) ↔ lock screen ↔ shut down
// All screen-level state (wallpaper, wifi, lock/shutdown) lives here
...
export default class Ubuntu extends Component<Record<string, never>, UbuntuState> {
    ...
    changeBackgroundImage = (img_name: string) => {
        ...
        return (
            <div className="w-screen h-screen overflow-hidden" id="monitor-screen">
                ...
                <BootingScreen
                    ...
                    turnOn={this.turnOn}
                />
                <Navbar lockScreen={this.lockScreen} shutDown={this.shutDown} wifi={this.state.wifi} onWifiChange={(val: boolean) => this.setState({ wifi: val })} />
                <Desktop bg_image_name={this.state.bg_image_name} changeBackgroundImage={this.changeBackgroundImage} wifi={this.state.wifi} />
            </div>
        );
    }
}
